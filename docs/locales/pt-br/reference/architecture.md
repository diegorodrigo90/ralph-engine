...
- a topologia do runtime evolui por registros tipados, para que ativação de plugin, registro de capability e enablement de MCP permaneçam explícitos em vez de reconstruídos ad hoc por comando
