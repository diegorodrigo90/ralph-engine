...
- Expandir os contratos do runtime além de metadados tipados, escopos de ativação, lifecycle, fronteiras de carregamento, runtime hooks e registro de topologia para uma orquestração de estado mais rica.
