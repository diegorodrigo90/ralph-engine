...
- Expand the runtime contracts beyond typed metadata, activation scopes, capability registration, lifecycle, load boundaries, runtime hooks, topology registration, health status, and issue reporting into richer runtime state orchestration.
