...
- Continue turning plugin contributions into executable contracts, such as template assets and prompt/runtime payloads, instead of metadata-only descriptors.
