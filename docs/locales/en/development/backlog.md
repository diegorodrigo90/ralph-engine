...
- Expand the runtime contracts beyond typed metadata, activation scopes, lifecycle, load boundaries, runtime hooks, and topology registration into richer runtime state orchestration.
