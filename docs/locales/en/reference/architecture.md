...
- runtime topology, health, issue reporting, and runtime action planning evolve through typed registrations and shared contracts so plugin activation, capability registration, and MCP enablement stay explicit instead of being reconstructed ad hoc per command
