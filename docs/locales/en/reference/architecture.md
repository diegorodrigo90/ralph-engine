...
- runtime topology, health, and issue reporting evolve through typed registrations and status contracts so plugin activation, capability registration, and MCP enablement stay explicit instead of being reconstructed ad hoc per command
