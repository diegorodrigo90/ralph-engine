...
catalog_str!(tui_type_run, tui_type_run);
catalog_str!(tui_type_init, tui_type_init);
catalog_str!(tui_type_init_tui, tui_type_init_tui);
catalog_str!(tui_orchestration_runtime, tui_orchestration_runtime);
catalog_str!(tui_waiting_session, tui_waiting_session);
catalog_str!(tui_help_keys_heading, tui_help_keys_heading);
catalog_str!(tui_help_plugin_keys, tui_help_plugin_keys);
catalog_str!(tui_help_commands_heading, tui_help_commands_heading);
catalog_str!(tui_help_type_slash, tui_help_type_slash);
