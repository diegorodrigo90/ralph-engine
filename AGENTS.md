...
24. Runtime registration and state orchestration SHALL remain typed and explicit. Plugin activation, runtime topology, MCP enablement, and future runtime state transitions SHALL evolve through shared contracts instead of implicit catalog traversal in command handlers.
