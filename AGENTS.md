...
36. Pages publication SHALL happen from release tags so the public site, docs, and plugins surface reflect published versions rather than unreleased `main` state.
