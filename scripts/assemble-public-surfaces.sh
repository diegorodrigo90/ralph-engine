...
cp "$ROOT_DIR/site/plugins/locales/en/index.html" "$OUTPUT_DIR/plugins/index.html"
cp "$ROOT_DIR/site/plugins/locales/pt-br/index.html" "$OUTPUT_DIR/pt-br/plugins/index.html"
cp "$ROOT_DIR/site/plugins/index.json" "$OUTPUT_DIR/plugins/index.json"
