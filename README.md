...
- Runtime registration stays typed: the resolved runtime topology for plugins, capabilities, and MCP contributions is expected to evolve through shared contracts rather than implicit command-local catalog traversal
