...
- Plugin and MCP extensibility stays typed: capabilities, lifecycle stages, configuration, and future contributions are expected to evolve through shared contracts rather than string-coupled runtime branches
