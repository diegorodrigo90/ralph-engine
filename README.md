...
- Runtime registration stays typed: the resolved runtime topology, capability registry, runtime health, and MCP contributions are expected to evolve through shared contracts rather than implicit command-local catalog traversal
