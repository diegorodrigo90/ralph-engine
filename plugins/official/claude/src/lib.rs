...
const LOCALIZED_NAMES: &[PluginLocalizedText] = &[PluginLocalizedText::new("pt-br", "Claude")];
const PLUGIN_SUMMARY: &str = "Claude agent runtime and MCP session integration.";
